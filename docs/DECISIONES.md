...
| D-052 | Autorizar a MAIN a preparar el estudio técnico sintético de C4-P como protocolo documental y mediante inspección de sólo lectura. Prepararlo no autoriza ejecutar experimentos, instalar, descargar o compilar proveedores, invocar Windows Hello o DPAPI, modificar código/configuración/lockfiles, seleccionar una dependencia, crear prompt/worktree/D9, usar Gmail/OAuth/datos reales/acciones, ni hacer commit o push. | Ejecutada como preparación documental; Fase A autorizada posteriormente por D-053 | Autorización explícita de Joa del 31 de agosto de 2026 y `docs/ESTUDIO_TECNICO_C4P.md` |
| D-053 | Autorizar exclusivamente la Fase A A1-A6 del estudio C4-P sin dependencias: inventario local, control negativo con SQLite estándar y DB/WAL/journal creados bajo raíces temporales, inspección de superficie, matriz documental de distribución, diseño del harness y análisis conceptual de IPC. No autoriza Fases B-D, descargar/instalar/compilar/enlazar proveedores, invocar DPAPI o Windows Hello, construir broker, modificar código/configuración/lockfiles, crear prompt/worktree/D9, usar Gmail/OAuth/datos reales/acciones, ni hacer commit o push. | Ejecutada; Fase A registrada y Fases B-D continúan bloqueadas | Autorización explícita de Joa del 1 de septiembre de 2026 y `docs/ESTUDIO_TECNICO_C4P.md` |
| D-054 | Aceptar el cierre auditado de Fase A C4-P desde la candidata aislada SHA-256 `DB50327F3EE524503E3D85F041452133777579A1F06BA3F5BBB2895AAA326AF3` y autorizar a MAIN a reemplazar el borrador previo, reconciliar únicamente la documentación durable, crear el commit documental y publicar sólo `main` en el `origin` privado verificado. Los worktrees detached `a0ea` y `eeaa` se conservan como evidencia y no amplían retroactivamente D-053. Esta decisión no autoriza B0 ni Fases B-D, proveedor o versión, descargas, instalaciones, build, enlace, dependencias, código/configuración/lockfiles, harness o IPC implementado, DPAPI, Windows Hello, Gmail, OAuth, credenciales, datos reales, D9 ni acciones. | Confirmada; se consolida por el commit que contiene esta decisión | Aceptación y autorización explícitas de Joa del 1 de septiembre de 2026, auditoría final de MAIN y `docs/ESTUDIO_TECNICO_C4P.md` |
...
publicación. D-052 autoriza preparar el protocolo técnico C4-P. D-053 autoriza y
cierra únicamente su Fase A sin dependencias. D-054 acepta esa evidencia final y
autoriza sólo su consolidación documental y publicación. No autoriza B0, Fases
B-D, implementar, agregar dependencias o comenzar D9.
